...
public class ShadowViewDrawable extends Drawable {
    ...
    public ShadowViewDrawable(Context context, ShadowProperty shadowProperty, int color, float rx, float ry) {
        ...
        borderPaint.setColor(Color.parseColor("#1A0081F8")); // Set the border color
        borderPaint.setStrokeWidth(dip2px(context, 0.6f)); // Set the border width
...
//            drawRect = new RectF(0, 0, width, height - shadowOffset);
    ...
    public void draw(Canvas canvas) {
        ...
        canvas.drawRoundRect(drawRect, rx, ry, borderPaint);
